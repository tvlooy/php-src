...
const zend_function_entry mysqli_link_methods[] = {
	...
	PHP_FALIAS(character_set_name, mysqli_character_set_name, arginfo_class_mysqli_character_set_name)
	PHP_FALIAS(close, mysqli_close, arginfo_class_mysqli_close)
	PHP_FALIAS(commit, mysqli_commit, arginfo_class_mysqli_commit)
	PHP_FALIAS(connect, mysqli_connect, arginfo_class_mysqli_connect)
	PHP_FALIAS(dump_debug_info, mysqli_dump_debug_info, arginfo_class_mysqli_dump_debug_info)
	PHP_FALIAS(debug, mysqli_debug, arginfo_class_mysqli_debug)
#ifdef HAVE_MYSQLI_GET_CHARSET
	PHP_FALIAS(get_charset, mysqli_get_charset, arginfo_class_mysqli_get_charset)
#endif
	PHP_FALIAS(get_client_info, mysqli_get_client_info, arginfo_class_mysqli_get_client_info)
#if defined(MYSQLI_USE_MYSQLND)
	PHP_FALIAS(get_connection_stats, mysqli_get_connection_stats, arginfo_class_mysqli_get_connection_stats)
#endif
	PHP_FALIAS(get_server_info, mysqli_get_server_info, arginfo_class_mysqli_get_server_info)
	PHP_FALIAS(get_warnings, mysqli_get_warnings, arginfo_class_mysqli_get_warnings)
	PHP_FALIAS(init, mysqli_init_method, arginfo_class_mysqli_init)
	...
	PHP_FALIAS(__construct, mysqli_link_construct, arginfo_class_mysqli___construct)
	PHP_FALIAS(more_results, mysqli_more_results, arginfo_class_mysqli_more_results)
	PHP_FALIAS(next_result, mysqli_next_result, arginfo_class_mysqli_next_result)
	PHP_FALIAS(options, mysqli_options, arginfo_class_mysqli_options)
	PHP_FALIAS(ping, mysqli_ping, arginfo_class_mysqli_ping)
#if defined(MYSQLI_USE_MYSQLND)
...
#if defined(MYSQLI_USE_MYSQLND)
	PHP_FALIAS(reap_async_query, mysqli_reap_async_query, arginfo_class_mysqli_reap_async_query)
#endif
	...
	PHP_FALIAS(stat, mysqli_stat, arginfo_class_mysqli_stat)
	PHP_FALIAS(stmt_init, mysqli_stmt_init, arginfo_class_mysqli_stmt_init)
	PHP_FALIAS(store_result, mysqli_store_result, arginfo_class_mysqli_store_result)
	PHP_FALIAS(thread_safe, mysqli_thread_safe, arginfo_class_mysqli_thread_safe)
	PHP_FALIAS(use_result, mysqli_use_result, arginfo_class_mysqli_use_result)
...
const zend_function_entry mysqli_result_methods[] = {
	...
	PHP_FALIAS(close, mysqli_free_result, arginfo_class_mysqli_result_close)
	PHP_FALIAS(free, mysqli_free_result, arginfo_class_mysqli_result_free)
	PHP_FALIAS(data_seek, mysqli_data_seek, arginfo_class_mysqli_result_data_seek)
	PHP_FALIAS(fetch_field, mysqli_fetch_field, arginfo_class_mysqli_result_fetch_field)
	PHP_FALIAS(fetch_fields, mysqli_fetch_fields, arginfo_class_mysqli_result_fetch_fields)
	PHP_FALIAS(fetch_field_direct, mysqli_fetch_field_direct, arginfo_class_mysqli_result_fetch_field_direct)
#if defined(MYSQLI_USE_MYSQLND)
	PHP_FALIAS(fetch_all, mysqli_fetch_all, arginfo_class_mysqli_result_fetch_all)
#endif
	PHP_FALIAS(fetch_array, mysqli_fetch_array, arginfo_class_mysqli_result_fetch_array)
	PHP_FALIAS(fetch_assoc, mysqli_fetch_assoc, arginfo_class_mysqli_result_fetch_assoc)
	PHP_FALIAS(fetch_object, mysqli_fetch_object, arginfo_class_mysqli_result_fetch_object)
	PHP_FALIAS(fetch_row, mysqli_fetch_row, arginfo_class_mysqli_result_fetch_row)
	PHP_FALIAS(field_seek, mysqli_field_seek, arginfo_class_mysqli_result_field_seek)
	PHP_FALIAS(free_result, mysqli_free_result, arginfo_class_mysqli_result_free_result)
	PHP_FE_END
};
/* }}} */
...
const zend_function_entry mysqli_stmt_methods[] = {
	...
	PHP_FALIAS(close, mysqli_stmt_close, arginfo_class_mysqli_stmt_close)
	PHP_FALIAS(data_seek, mysqli_stmt_data_seek, arginfo_class_mysqli_stmt_data_seek)
	PHP_FALIAS(execute, mysqli_stmt_execute, arginfo_class_mysqli_stmt_execute)
	PHP_FALIAS(fetch, mysqli_stmt_fetch, arginfo_class_mysqli_stmt_fetch)
	PHP_FALIAS(get_warnings, mysqli_stmt_get_warnings,	arginfo_class_mysqli_stmt_get_warnings)
	PHP_FALIAS(result_metadata, mysqli_stmt_result_metadata, arginfo_class_mysqli_stmt_result_metadata)
#if defined(MYSQLI_USE_MYSQLND)
	PHP_FALIAS(more_results, mysqli_stmt_more_results, arginfo_class_mysqli_stmt_more_results)
	PHP_FALIAS(next_result, mysqli_stmt_next_result, arginfo_class_mysqli_stmt_next_result)
#endif
	PHP_FALIAS(num_rows, mysqli_stmt_num_rows, arginfo_class_mysqli_stmt_num_rows)
	PHP_FALIAS(send_long_data, mysqli_stmt_send_long_data, arginfo_class_mysqli_stmt_send_long_data)
	PHP_FALIAS(free_result, mysqli_stmt_free_result, arginfo_class_mysqli_stmt_free_result)
	PHP_FALIAS(reset, mysqli_stmt_reset, arginfo_class_mysqli_stmt_reset)
	PHP_FALIAS(prepare, mysqli_stmt_prepare, arginfo_class_mysqli_stmt_prepare)
	PHP_FALIAS(store_result, mysqli_stmt_store_result, arginfo_class_mysqli_stmt_store_result)
#if defined(MYSQLI_USE_MYSQLND)
	PHP_FALIAS(get_result, mysqli_stmt_get_result, arginfo_class_mysqli_stmt_get_result)
#endif
	PHP_FE_END
};
/* }}} */
